...
router.post(
    ...
    async (req, res) => {
        try {
            ...
            if (!errors.isEmpty()) {
                return res.status(400).json({ errors: errors.array(), message: 'Wrong data on registration' });
            }
...
router.post(
    ...
    async (req, res) => {
        try {
            ...
            if (!errors.isEmpty()) {
                return res.status(400).json({ errors: errors.array(), message: 'Wrong data on login' });
            }
